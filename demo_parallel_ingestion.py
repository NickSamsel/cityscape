...
def demo_parallel_ingestion():
    ...
    print("NEXT STEPS:")
    print("=" * 70)
    print("1. Run full season ingestion with parallel:")
    ...
    print()
    print("2. Or use the test script for a small sample:")
    print("   uv run python tests/test_player_stats_integration.py")
    print()
